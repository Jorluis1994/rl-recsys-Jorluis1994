...
1. **El diagnostico, escrito en su bitacora antes de tocar el codigo.** Por que
   ...
   el recall va atener 0.70 ya que los estudiantes van a tender a aplicar habilidades
   que ya ahn trabajado, por lo cque el estudiante tiene una señal fueret de predecir
   tambien explciara por que al tener habilidades que el estudiante no ha practicado
   se eliminarian las señales de los datos repetidos.
...
def mi_recomendador(particion: Particion):
    ...
    #return knn_items(particion, vecinos=100)
